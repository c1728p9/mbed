...
def test_device(serial_number, log=print):
        ...
        #-connect/disconnect tests - have device disconnect and then reconnect
            #-connect/disconnect notifications (if applicable)
...
def control_stress_test(dev, log):
    ...
    for _ in range(100):
        ...
        request_type = 0xC0                         # Device-to-host, Vendor request to Device
        request = VENDOR_TEST_CTRL_IN               # Vendor custom request
    ...
    for _ in range(100):
        ...
        request_type = 0x40                         # Host-to-device, Vendor request to Device
        request = VENDOR_TEST_CTRL_OUT              # Nonsense request
        value = 8                                   # Size of data the device should actually read
        index = count                                   # Communication interface
